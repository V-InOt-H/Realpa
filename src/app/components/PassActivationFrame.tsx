import svgPaths from "../../imports/Group9/svg-woos0xqi8q";
import imgIPhone1617Pro2 from "../../imports/Group9/2dadf32d9b24520cae70cd3a58d0f16672ad325f.png";
import imgRealPass1 from "../../imports/Group9/671bdc45a830fbdbad392677f1d1d3c5865b7339.png";
import imgQwr1 from "../../imports/Group9/adb4cdf593b45fc3e85212ac5c399eed41c39775.png";
import imgVk61 from "../../imports/Group9/d3550ae37bcbcc46631351e98c4a9aa61fdc8926.png";
import { ArrowLeft } from "lucide-react";

interface PassActivationFrameProps {
      ...
      <div className="absolute flex h-[215.651px] items-center justify-center left-[71px] top-[546px] w-[299.003px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "22" } as React.CSSProperties}>
        <div className="-rotate-6 flex-none">
          <div className="h-[187.308px] relative rounded-[4px] w-[280.963px]" data-name="passs 1">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[4px] size-full" src={imgIPhone1617Pro2} />
          </div>
        </div>
      </div>
    </div>
...
export default function PassActivationFrame({ onNavigate }: PassActivationFrameProps) {
  return (
    <div
    ...
    >
      ...
      <div className="absolute h-[874px] left-[8px] opacity-10 overflow-clip top-0 w-[402px]" data-name="iPhone 16 & 17 Pro - 2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgIPhone1617Pro2} />
        ...
        <div className="absolute flex h-[27.058px] items-center justify-center left-[32px] top-[651px] w-[84.061px]" style={{ "--transform-inner-width": "64", "--transform-inner-height": "22" } as React.CSSProperties}>
      ...
      <div className="absolute flex h-[126.528px] items-center justify-center left-[102.37px] top-[376.62px] w-[211.06px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "22" } as React.CSSProperties}>
        <div className="flex-none rotate-[-1.03deg]">
          <div className="h-[122.779px] relative rounded-[15px] w-[208.878px]">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[15px] size-full" src={imgIPhone1617Pro2} />
          </div>
        </div>
      </div>
