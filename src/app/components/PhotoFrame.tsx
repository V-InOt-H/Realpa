import svgPaths from "../../imports/Group11/svg-kag1zgvwmt";
import imgRealPass1 from "../../imports/Group11/671bdc45a830fbdbad392677f1d1d3c5865b7339.png";
import imgPasss1 from "../../imports/Group11/2dadf32d9b24520cae70cd3a58d0f16672ad325f.png";
import imgQwr1 from "../../imports/Group11/adb4cdf593b45fc3e85212ac5c399eed41c39775.png";
import imgVk61 from "../../imports/Group11/d3550ae37bcbcc46631351e98c4a9aa61fdc8926.png";
import imgImage1 from "../../imports/Group11/6bf402b5002f1274e358e6bd7c288b2f93bbc7f8.png";
...
export default function PhotoFrame({ onNavigate }: PhotoFrameProps) {
  return (
    <div
    ...
    >
      ...
      <div className="absolute h-[389px] left-[7px] top-[266px] w-[395px]" data-name="image 1">
        <img alt="Photo Preview" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage1} />
      </div>
    </div>
  );
}
