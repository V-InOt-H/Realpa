import svgPaths from "./svg-woos0xqi8q";
import imgIPhone1617Pro2 from "./2dadf32d9b24520cae70cd3a58d0f16672ad325f.png";
...
function Group2() {
  return (
    <div className="absolute contents left-[8px] top-0">
      <IPhone1617Pro />
    </div>
  );
}
...
function Group1() {
  return (
    <div className="absolute contents h-[317.732px] left-0 top-[278px] w-[417.811px]">
