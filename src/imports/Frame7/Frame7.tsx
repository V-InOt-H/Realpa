import svgPaths from "./svg-u9kjemx1g5";
...
function Frame() {
  return <div className="absolute h-[60px] left-[23px] top-[626px] w-[95px]" />;
}

function Group2() {
  return (
    <div className="absolute contents left-[23px] top-[626px]">
      <Frame />
      <p className="absolute font-['Kode_Mono:Regular',sans-serif] font-normal leading-[normal] left-[48px] text-[12px] text-black top-[634px] whitespace-nowrap">Apr 13</p>
      <div className="absolute flex h-[27.058px] items-center justify-center left-[28px] top-[656px] w-[84.061px]" style={{ "--transform-inner-width": "64", "--transform-inner-height": "22" } as React.CSSProperties}>
